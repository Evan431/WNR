...
class TestModel(TestCase):
    # Données en commun dans plusieurs
    ...
    def TestProgramme(self): 
        programme1 = Programme.objects.create(titre='Avatar', titreOriginal='Avatar', bandeAnnonce='https://youtu.be/O1CzgULNRGs', popularite=4.2, affiche='avatar.png', note_global=8.5, description="Le personnage central de l'histoire, Jake Sully, un marine paraplégique doté d'un avatar, va devoir choisir son camp avec pour enjeu le destin de la planète. La conception d'Avatar débute en 1994 lorsque Cameron, âgé de 40 ans, finalise un script de 80 pages.", date='2009-12-16')
        ...
        programme2 = Programme.objects.create(titre='Avatar 2', titreOriginal='Avatar 2', bandeAnnonce='https://youtu.be/5uSCcKyR-eQ', popularite=4.8, affiche='avatar2.png', note_global=9, description="Se déroulant plus d'une décennie après les événements relatés dans le premier film, AVATAR : LA VOIE DE L'EAU raconte l'histoire des membres de la famille Sully (Jake, Neytiri et leurs enfants), les épreuves auxquelles ils sont confrontés, les chemins qu'ils doivent emprunter pour se protéger les uns les autres, ...", date='2022-12-14')
        programme2.listPersonne.add(self.person1)
        programme2.listGenre.add(self.genre1)
        programme2.listCompaProd.add(self.compaProd2)

        #Quelques vérifications seulement 
